...
namespace ProiectMDS.DAL.Migrations
{
    ...
    [Migration("20220513010002_PhotosUpdate1_la_1")]
    partial class PhotosUpdate1_la_1
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProiectMDS.DAL.Entities.BaseCourses", b =>
                {
            ...
            modelBuilder.Entity("ProiectMDS.DAL.Entities.Photos", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ProiectMDS.DAL.Entities.UserProfile", b =>
                {
                    ...
                    b.HasIndex("PhotosId")
                        .IsUnique()
                        .HasFilter("[PhotosId] IS NOT NULL");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("ProiectMDS.DAL.Entities.Auth.Role", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("ProiectMDS.DAL.Entities.Auth.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ProiectMDS.DAL.Entities.UserProfile", b =>
                {
                    ...
                    b.HasOne("ProiectMDS.DAL.Entities.Photos", "Photos")
                        .WithOne("UserProfile")
                        .HasForeignKey("ProiectMDS.DAL.Entities.UserProfile", "PhotosId");
