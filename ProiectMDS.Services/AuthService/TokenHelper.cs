...
namespace ProiectMDS.Services.Helpers
{
    public class TokenHelper : ITokenHelper
    {
        ...
        public async Task<string> CreateAccesToken(User user)
        {
            ...
            var secret = _configuration.GetSection("JWT").GetSection("Secret").Get<String>();
            ...
            var tokenDescriptor = new SecurityTokenDescriptor
            {
                ...
                Issuer = _configuration.GetSection("JWT").GetSection("Secret").Get<string>()
            };
